...
$CommentCreateCon = new Bbs\Controller\CommentCreate();
$CommentCreateCon->run();
// $threadCon->run();
  ...
  <div class="thread__item">
    ...
    <form action="" method="post" class="form-group">
      <div class="form-group">
        <label>コメント</label>
        <textarea type="text" name="content" class="form-control"><?= isset($CommentCreateCon->getValues()->content) ? h($CommentCreateCon->getValues()->content) : ''; ?></textarea>
        <p class="err"><?= h($CommentCreateCon->getErrors('content')); ?></p>
      </div>
      <div class="form-group">
